...
public class rANSBaseEncoder {

  private int RANS_BYTE_L = 1 << 23;
  private int state = RANS_BYTE_L;

  public rANSBaseEncoder(OutputStream out) {
    super();
    this.out = out;
  }
  ...
  public void append(final int scaleBits, final int start, final int freq) {
    scaleBitsHistory.push(scaleBits);
